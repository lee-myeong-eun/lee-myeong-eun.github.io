...
try:
    with open('C:/Users/user/Desktop/한국폴리텍대학_AI소프트에어활용및코딩/반복문 문제.ipynb', encoding='utf-8') as f:
        d = json.load(f)
except Exception as e:
    print("Error reading the notebook:", e)
    exit(1)

out_path = 'c:/Users/user/Desktop/lee-myeong-eun.github.io/_pages/python-loop-problems.md'

with open(out_path, 'w', encoding='utf-8') as out:
    out.write('---\n')
    out.write('layout: default\n')
    out.write('title: Python 반복문 문제풀이\n')
    out.write('permalink: /assignments/python-loop-problems/\n')
    out.write('---\n\n')

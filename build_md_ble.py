...
out_path = 'C:/Users/user/Desktop/lee-myeong-eun.github.io/_pages/ble-notebook.md'

with open(out_path, 'w', encoding='utf-8') as out:
    out.write('---\n')
    out.write('layout: default\n')
    out.write('title: BLE 기반 공사장 안전장비 실시간 감지 시스템 코드 리뷰\n')
    out.write('permalink: /projects/ble-notebook/\n')
    out.write('---\n\n')
    ...
    out.write('## BLE 기반 공사장 안전장비 실시간 감지 시스템\n\n')
    ...
    for cell in d.get('cells', []):
        ...
        if cell['cell_type'] == 'markdown':
            ...
            out.write('```c\n' + source + '\n```\n\n') # Assuming mostly C/C++ (ESP32 code) or Python in this notebook. Let's use 'c' as default syntax highlighting, or 'python' based on content. The notebook has both Arduino and Python. Let's just use 'python' for syntax highlighting as a fallback or 'cpp'

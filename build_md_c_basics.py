...
try:
    with open('C:/Users/user/Desktop/c언어_기초문법_정리.ipynb', encoding='utf-8') as f:
        d = json.load(f)
except Exception as e:
    print("Error reading the notebook:", e)
    exit(1)

out_path = 'c:/Users/user/Desktop/lee-myeong-eun.github.io/_pages/c-programming-basics.md'

with open(out_path, 'w', encoding='utf-8') as out:
    out.write('---\n')
    out.write('layout: default\n')
    out.write('title: C언어 기초문법 정리\n')
    out.write('permalink: /assignments/c-programming-basics/\n')
    out.write('---\n\n')
